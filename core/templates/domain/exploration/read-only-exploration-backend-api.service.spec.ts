...
describe('Read only exploration backend API service', () => {
  ...
  let sampleDataResultsBackendResponse: FetchExplorationBackendResponse = {
    exploration_id: '0',
    is_logged_in: true,
    session_id: 'KERH',
  ...
  let sampleDataResults: Exploration;
  ...
  beforeEach(() => {
    ...
    sampleDataResults = eof.createFromExplorationBackendResponse(
      sampleDataResultsBackendResponse
    );
  });
