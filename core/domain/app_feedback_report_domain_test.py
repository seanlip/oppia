...
class AppFeedbackReportDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        android_app_context = app_feedback_report_domain.AndroidAppContext(
            navigation_drawer_entry_point,
            LANGUAGE_LOCALE_CODE_ENGLISH,
            LANGUAGE_LOCALE_CODE_ENGLISH,
            ANDROID_TEXT_SIZE,
        ...
        web_user_supplied_feedback = app_feedback_report_domain.UserSuppliedFeedback(
            REPORT_TYPE_SUGGESTION,
            CATEGORY_SUGGESTION_OTHER,
            USER_SELECTED_ITEMS,
            USER_TEXT_INPUT,
        )
        device_system_context = app_feedback_report_domain.DeviceSystemContext(
            WEB_PLATFORM_VERSION, LANGUAGE_LOCALE_CODE_ENGLISH
        )
        crash_entry_point = app_feedback_report_domain.CrashEntryPoint()
        app_context = app_feedback_report_domain.AppContext(
            crash_entry_point,
            LANGUAGE_LOCALE_CODE_ENGLISH,
            LANGUAGE_LOCALE_CODE_ENGLISH,
        )
    ...
    def test_to_dict_android_report(self) -> None:
        ...
        expected_dict = {
            ...
            'app_context': {
                'entry_point': {'entry_point_name': ENTRY_POINT_NAVIGATION_DRAWER},
    ...
    def test_report_scrubber_id_is_not_string_validation_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.android_report_obj, 'The scrubbed_by user must be a string'
        )
    ...
    def test_report_timezone_offset_is_invalid_validation_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.android_report_obj, 'Expected local timezone offset to be in'
        )
    ...
    def test_get_report_type_from_string_returns_expected_report_type(self) -> None:
        ...
        for report_type in app_feedback_report_constants.ReportType:
            self.assertEqual(
                feedback_report.get_report_type_from_string(report_type.value),
                report_type,
            )
    ...
    def test_get_category_from_string_returns_expected_category(self) -> None:
        ...
        for category in app_feedback_report_constants.ALLOWED_CATEGORIES:
            self.assertEqual(
                feedback_report.get_category_from_string(category.value), category
            )
    ...
    def test_get_android_text_size_from_string_returns_expected_text_size(self) -> None:
        ...
        for text_size in app_feedback_report_constants.ALLOWED_ANDROID_TEXT_SIZES:
            self.assertEqual(
                feedback_report.get_android_text_size_from_string(text_size.value),
                text_size,
            )
    ...
    def test_get_entry_point_from_json_returns_expected_entry_point_obj(self) -> None:
        ...
        navigation_drawer_obj = feedback_report.get_entry_point_from_json(
            entry_point_json
        )
        self.assertTrue(
            isinstance(
        ...
        self.assertTrue(
            isinstance(
                lesson_player_obj, app_feedback_report_domain.LessonPlayerEntryPoint
            )
        )
        ...
        self.assertTrue(
            isinstance(
                revision_card_obj, app_feedback_report_domain.RevisionCardEntryPoint
            )
        )
        ...
        self.assertTrue(
            isinstance(crash_obj, app_feedback_report_domain.CrashEntryPoint)
        )
...
class UserSuppliedFeedbackDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        super().setUp()
        self.user_supplied_feedback = app_feedback_report_domain.UserSuppliedFeedback(
            REPORT_TYPE_SUGGESTION,
            CATEGORY_SUGGESTION_OTHER,
            USER_SELECTED_ITEMS,
            USER_TEXT_INPUT,
    ...
    def test_validation_invalid_report_category_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.user_supplied_feedback, 'Invalid category invalid_category,'
        )
    ...
    def test_validation_selected_items_is_none_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.user_supplied_feedback, 'No user_feedback_selected_items supplied'
        )
    ...
    def test_validation_invalid_text_input_with_only_text_input_allowed_fails(
        ...
        self._assert_validation_error(
            self.user_supplied_feedback, 'Invalid input text, must be a string'
        )
...
class DeviceSystemContextDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        super().setUp()
        self.device_system_context = app_feedback_report_domain.DeviceSystemContext(
...
class AndroidDeviceSystemContextTests(test_utils.GenericTestBase):
    ...
    def test_validation_invalid_version_name_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.device_system_context, 'The version name is not a valid string format'
        )
    ...
    def test_validation_package_version_code_less_than_minimum_fails(self) -> None:
        ...
        self._assert_validation_error(
            ...
            'supported version is %d' % (feconf.MINIMUM_ANDROID_PACKAGE_VERSION_CODE),
        )
    ...
    def test_validation_country_locale_code_is_none_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.device_system_context, 'No device country locale code supplied.'
        )
    ...
    def test_validation_language_locale_code_is_none_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.device_system_context, 'No device language locale code supplied.'
        )
    ...
    def test_validation_device_model_is_none_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.device_system_context, 'No device model supplied.'
        )
    ...
    def test_validation_device_model_not_a_string_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.device_system_context, 'Android device model must be an string'
        )
...
class LessonPlayerEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def test_validation_name_not_a_string_fails(self) -> None:
        self.entry_point.entry_point_name = 123  # type: ignore[assignment]
        self._assert_validation_error(
            self.entry_point, 'Entry point name must be a string,'
        )
    ...
    def test_validation_invalid_topic_id_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.entry_point, 'Topic id %s is invalid' % 'invalid_topic_id'
        )
    ...
    def test_validation_invalid_exploration_id_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.entry_point,
            'Exploration with id invalid_exploration is not part of story ' 'with id',
        )
    ...
    def test_validation_exploration_id_not_a_stringfails(self) -> None:
        ...
        self._assert_validation_error(
            self.entry_point, 'Exploration id should be a string'
        )
    ...
    def test_validation_story_id_fails_on_none_value(self) -> None:
        ...
        self._assert_validation_error(
            self.entry_point, 'The story_id must be a string value, received None'
        )
...
class RevisionCardEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        super().setUp()
        self.entry_point = app_feedback_report_domain.RevisionCardEntryPoint(
...
class CrashEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def test_to_dict(self) -> None:
        expected_dict = {
            'entry_point_name': (app_feedback_report_constants.EntryPoint.CRASH.value)
        }
        self.assertDictEqual(expected_dict, self.entry_point.to_dict())
...
class AppContextDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.app_context = app_feedback_report_domain.AppContext(
            entry_point, LANGUAGE_LOCALE_CODE_ENGLISH, LANGUAGE_LOCALE_CODE_ENGLISH
        )
...
class AndroidAppContextDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        super().setUp()
        entry_point = app_feedback_report_domain.NavigationDrawerEntryPoint()
        self.app_context = app_feedback_report_domain.AndroidAppContext(
            entry_point,
            LANGUAGE_LOCALE_CODE_ENGLISH,
            LANGUAGE_LOCALE_CODE_ENGLISH,
            ANDROID_TEXT_SIZE,
    ...
    def test_validation_text_language_code_is_not_a_string_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.app_context, 'Expected the app\'s text language code to be a string'
        )
    ...
    def test_validation_audio_language_code_is_not_a_string_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.app_context, 'Expected the app\'s audio language code to be a string'
        )
    ...
    def test_validation_text_language_code_does_not_match_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.app_context, 'The app\'s text language code is not a valid string'
        )
    ...
    def test_validation_audio_language_code_does_not_match_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.app_context, 'The app\'s audio language code is not a valid string'
        )
    ...
    def test_validation_automatically_update_topics_is_none_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.app_context, 'automatically_update_topics field should be a boolean'
        )
    ...
    def test_validation_account_is_profile_admin_is_none_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.app_context, 'account_is_profile_admin field should be a boolean'
        )
...
class AppFeedbackReportTicketDomainTests(test_utils.GenericTestBase):
    ...
    def test_validation_ticket_id_not_a_string_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.ticket_obj, 'The ticket id should be a string'
        )

    def test_validation_invalid_ticket_id_fails(self) -> None:
        self.ticket_obj.ticket_id = 'invalid_ticket_id'
        self._assert_validation_error(
            self.ticket_obj, 'The ticket id %s is invalid' % 'invalid_ticket_id'
        )
    ...
    def test_validation_ticket_name_is_not_a_string_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.ticket_obj, 'The ticket name should be a string'
        )
    ...
    def test_validation_github_repo_name_not_a_string_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.ticket_obj, 'The Github repo name should be a string'
        )

    def test_validation_invalid_github_repo_name_fails(self) -> None:
        self.ticket_obj.github_issue_repo_name = 'invalid_repo_name'
        self._assert_validation_error(
            self.ticket_obj, 'The Github repo %s is invalid' % 'invalid_repo_name'
        )
    ...
    def test_validation_archived_is_not_boolean_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.ticket_obj, 'The ticket archived status must be a boolean'
        )
...
class AppFeedbackReportDailyStatsDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        app_feedback_report_models.AppFeedbackReportModel.create(
            ...
            REPORT_SUBMITTED_TIMESTAMP,
            0,
            REPORT_TYPE_SUGGESTION.value,
            CATEGORY_SUGGESTION_OTHER.value,
            ANDROID_PLATFORM_VERSION,
            COUNTRY_LOCALE_CODE_INDIA,
            ANDROID_SDK_VERSION,
            ANDROID_DEVICE_MODEL,
        ...
        self.stats_id = (
            app_feedback_report_models.AppFeedbackReportStatsModel.calculate_id(
                PLATFORM_ANDROID, self.ticket_id, REPORT_SUBMITTED_TIMESTAMP.date()
            )
        )
    ...
    def test_validation_total_reports_submitted_is_not_an_int_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.stats_obj, 'The total number of submitted reports should be an int'
        )
    ...
    def test_validation_total_reports_submitted_is_less_than_0_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.stats_obj,
            'The total number of submitted reports should be a non-negative ' 'int',
        )
    ...
    def test_validation_invalid_daily_param_stats_fails(self) -> None:
        self.stats_obj.daily_param_stats = {
            'invalid_stat_name': app_feedback_report_domain.ReportStatsParameterValueCounts(
                {'invalid_stats': 0}
            ),
        }
        self._assert_validation_error(
...
class AppFeedbackReportFilterDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.filter = app_feedback_report_domain.AppFeedbackReportFilter(
            app_feedback_report_constants.FilterFieldNames.PLATFORM, ['web', 'android']
        )
    ...
    def test_validation_filter_values_list_is_none_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.filter, 'The filter options should be a list'
        )
