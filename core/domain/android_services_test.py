...
class AndroidBuildSecretTests(test_utils.GenericTestBase):
    ...
    @mock.patch('core.domain.android_services.secrets_services.get_secret')
    def test_cloud_secrets_return_none_logs_exception(
        self, mock_get_secret: mock.Mock
    ) -> None:
    ...
    @mock.patch('core.domain.android_services.secrets_services.get_secret')
    def test_cloud_secrets_return_secret_passes(
        self, mock_get_secret: mock.Mock
    ) -> None:
