...
LANGUAGE_CODE_TO_SAMPLE_VOICEOVER_FILENAMES = {
    'en': [
        'autogenerated_english_voiceover_1.mp3',
        'autogenerated_english_voiceover_2.mp3'
    ],
...
def regenerate_speech_from_text(
    ...
    if language_code not in LANGUAGE_CODE_TO_SAMPLE_VOICEOVER_FILENAMES.keys():
        # Deafult language code.
        language_code = 'en'

    sample_voiceover_filenames = LANGUAGE_CODE_TO_SAMPLE_VOICEOVER_FILENAMES[
        language_code]

    selected_voiceover_filename = random.randint(
        0, len(sample_voiceover_filenames))

    voiceover_path = os.path.join(
        feconf.SAMPLE_AUTO_VOICEOVERS_DATA_DIR,
        sample_voiceover_filenames[selected_voiceover_filename])
