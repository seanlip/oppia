...
class PlanCopyMissingTranslationImgsFromExp(beam.PTransform):  # type: ignore[misc]
    """Plan the copy operation. This is a helper PTransform for
    CopyMissingTranslationImgsFromExpJob."""
    ...
    def expand(self, pipeline: beam.Pipeline) -> Tuple[
        ...
        dst_to_copy_by_src = (
            ...
            >> beam.MapTuple(lambda src, info: (src, info['dst']))
        )
    ...
    def _filter_copy_ops(
        ...
        Raises:
            ...
            the values of either src_exist or dst_exist do not have length 1.
        """
        _, copy_info = group
        if (
...
class CopyMissingTranslationImgsFromExpJob(base_jobs.JobBase):
    ...
    def run(self) -> beam.PCollection[job_run_result.JobRunResult]:
        ...
        dst_to_copy_by_src, _ = (
            ...
            >> PlanCopyMissingTranslationImgsFromExp()
        )
...
class AuditCopyMissingTranslationImgsFromExpJob(base_jobs.JobBase):
